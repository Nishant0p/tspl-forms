            ...
            {questionsContent.map((element) => {
              ...
              return (
                <div
                  key={element.id}
                  className={cn(
                    "w-full bg-card text-card-foreground p-5 sm:p-6 rounded-xl border border-border shadow-sm border-l-[5px] border-l-blue-600 focus-within:border-l-[6px] focus-within:border-l-orange-500 focus-within:ring-2 focus-within:ring-orange-500/20",
            ...
            {thankYouElement && (
              <div className="mt-6 border-t border-border/80 pt-6">
                ...
                <div className="flex w-full flex-col gap-4 bg-card text-card-foreground p-6 rounded-2xl border border-border shadow-md overflow-hidden relative">
                  ...
                  <div className="h-3 w-full flex overflow-hidden absolute top-0 left-0 right-0">
                    <div className="w-1/2 bg-blue-600 dark:bg-blue-500" />
                    <div className="w-[40%] bg-orange-500 dark:bg-orange-600" />
                    <div className="w-[10%] bg-white border-l border-orange-400/40" />
                  </div>
                  ...
                  <div className="flex items-center gap-3 border-b border-border/80 pb-3 mt-1">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500/15 to-orange-500/15 border border-blue-500/20 text-blue-600 dark:text-blue-400 shrink-0">
                      <PartyPopper className="h-6 w-6 text-orange-500" />
                    </div>
                    <div>
                      <span className="text-[11px] font-bold uppercase tracking-wider text-orange-600 dark:text-orange-400">Response Recorded</span>
                  ...
                  {thankYouElement.extraAttributes?.showRedirectButton && (
                    <div>
                      <span className="inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 text-white px-5 py-2.5 text-xs font-bold shadow-md shadow-orange-500/25">
